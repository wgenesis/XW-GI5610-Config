...
# @Time     : 2021/2/28 下午3:50
from PyQt5.QtCore import (QRect, QRectF, QTimer, pyqtSignal, Qt)
...
class SwitchBtn(QWidget):
    ...
    def __init__(self, size=None, geometry=None, name=None, parent=None):
